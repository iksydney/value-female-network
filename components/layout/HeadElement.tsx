...
function HeadElement({
	pageTitle = 'Value Female Network',
	description = 'We are committed to tackling harmful and deleterious social and gender norms',
	noIndex = false,
	siteLink = 'https://value-female-network.vercel.app/',
}: {
	pageTitle?: string;
	description?: string;
	noIndex?: boolean;
